...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FUELO — Nutrition for independent restaurants" },
      {
        name: "description",
        content:
          "Discover independent restaurants and see estimated calories, protein and macros for every dish. Nutrition for the way you eat out.",
      },
